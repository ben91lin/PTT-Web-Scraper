...
def test__check_url(instance, url, expected):
    assert instance._Connection__check_url(url) == expected
...
def test_looking_for_board(instance):
    ...
    assert instance._Connection__status == status_for_board
